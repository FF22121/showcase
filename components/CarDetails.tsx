  ...
  return (
    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      onClose={closeModal}>
        ...
        leave='easy-in duration-200 duration-200'
            ...
            <button
             ...
             <div className='flex-1 flex flex-col gap-3'>
              ...
              <div className='flex gap-3'>
                <div className='flex-1 relative w-full h-24 border-r-primary-blue-100
                rounded-lg'>
             ...
             <div className='flex-1 flex flex-col gap-2'>
              ...
              gap-4'>
                {Object.entries(car).map(([key,value]) => (
                  ...
                  text-right' key={key}>
                    <h4 className='text-grey capitalize'>{key.split("_mpg").join
                    ("")}</h4>
