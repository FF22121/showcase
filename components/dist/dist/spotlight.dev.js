...
function Spotlight(_a) {
  ...
  var mouse = react_1.useRef({
    x: 0,
    y: 0
  });
  var containerSize = react_1.useRef({
    w: 0,
    h: 0
  });
  ...
  react_1.useEffect(function () {
    containerRef.current && setBoxes(Array.from(containerRef.current.children).map(function (el) {
      return el;
    }));
  }, []);
  react_1.useEffect(function () {
